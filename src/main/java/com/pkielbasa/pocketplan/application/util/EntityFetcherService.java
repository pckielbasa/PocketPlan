...
public class EntityFetcherService {
    ...
    public Transaction fetchTransactionOrThrow(Long transactionId) {
        return transactionRepository.getTransactionById(transactionId)
                .orElseThrow(() -> new EntityNotFoundException("Transaction by id: " + transactionId + " not found"));
    }

    public Budget fetchBudgetOrThrow(Long budgetId) {
        return budgetRepository.getBudgetById(budgetId)
                .orElseThrow(() -> new EntityNotFoundException("Budget by id: " + budgetId + " not found"));
    }
